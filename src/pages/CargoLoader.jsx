...
const COMPARISON = [
  { metric: 'Energy cost per km', diesel: '₹4.90', sgd: '₹0.31', better: true },
  { metric: 'Monthly maintenance', diesel: '₹4,200', sgd: 'Included', better: true },
  { metric: 'Permit and fitness', diesel: '₹18,000 / yr', sgd: 'Included', better: true },
  { metric: 'Driver required', diesel: 'Yes', sgd: 'Yes', better: false },
  { metric: 'CO₂ per 100 km', diesel: '24.6 kg', sgd: '0 kg tailpipe', better: true },
  { metric: 'City entry restrictions', diesel: 'Increasing', sgd: 'Exempt', better: true },
]
  ...
  return (
    <>
      ...
      <Section id="comparison" tone="dark">
        ...
        <RevealGroup className="mx-auto mt-14 max-w-4xl overflow-hidden rounded-3xl border border-white/10">
          <RevealItem className="grid grid-cols-[1.4fr_1fr_1fr] gap-4 bg-white/[.06] px-6 py-4 text-[11px] font-semibold uppercase tracking-[.14em] text-white/65">
            ...
            <span className="text-center text-volt-400">SGD loader</span>
          </RevealItem>
        ...
        <p className="mx-auto mt-8 max-w-2xl text-center text-xs leading-relaxed text-white/55">
          ...
          quarterly servicing. SGD figures assume ₹8.40/kWh commercial tariff. Driver cost is
      ...
      <FeatureGrid
        ...
        lead="SGD OS ships with the fleet. No separate licence, no per-seat fee."
        items={OPS}
        tone="muted"
        cols={4}
      />
